...
def get_params():
    ...
    parser.add_argument('--summarizer_data_path', dest='summarizer_data_path', type=str, default=None,
                        help='Summarizer Dataset Path')
    parser.add_argument('--classifier_data_path', dest='classifier_data_path', type=str, default=None,
                        help='Classifier Dataset Path')
