...
def get_main_params():
    ...
    parser.add_argument('--train_data_dir', dest='train_data_dir', type=str, default=None)
    parser.add_argument('--val_data_dir', dest='val_data_dir', type=str, default=None)
    parser.add_argument('--test_data_dir', dest='test_data_dir', type=str, default=None)
